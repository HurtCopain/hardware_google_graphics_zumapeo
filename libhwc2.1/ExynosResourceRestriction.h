...
#ifndef EXYNOS_RESOURCE_RESTRICTION_ZUMAPRO_H_
#define EXYNOS_RESOURCE_RESTRICTION_ZUMAPRO_H_

#include "../../zuma/libhwc2.1/ExynosResourceRestriction.h"

namespace zumapro {

static feature_support_t feature_table[] = {
    {MPP_DPP_GFS, MPP_ATTR_AFBC | MPP_ATTR_BLOCK_MODE | MPP_ATTR_WINDOW_UPDATE |
                      MPP_ATTR_SCALE | MPP_ATTR_ROT_90 | MPP_ATTR_FLIP_H |
                      MPP_ATTR_FLIP_V | MPP_ATTR_DIM | MPP_ATTR_WCG |
                      MPP_ATTR_HDR10 | MPP_ATTR_HDR10PLUS |
                      MPP_ATTR_LAYER_TRANSFORM},

    {MPP_DPP_VGRFS, MPP_ATTR_AFBC | MPP_ATTR_BLOCK_MODE |
                        MPP_ATTR_WINDOW_UPDATE | MPP_ATTR_SCALE |
                        MPP_ATTR_FLIP_H | MPP_ATTR_FLIP_V | MPP_ATTR_ROT_90 |
                        MPP_ATTR_DIM | MPP_ATTR_WCG | MPP_ATTR_HDR10 |
                        MPP_ATTR_HDR10PLUS | MPP_ATTR_LAYER_TRANSFORM},

    {MPP_G2D, MPP_ATTR_AFBC | MPP_ATTR_SCALE | MPP_ATTR_FLIP_H |
                  MPP_ATTR_FLIP_V | MPP_ATTR_ROT_90 | MPP_ATTR_WCG |
                  MPP_ATTR_HDR10 | MPP_ATTR_HDR10PLUS | MPP_ATTR_USE_CAPA |
                  MPP_ATTR_LAYER_TRANSFORM}};
...
static ppc_table ppc_table_map = {
    /* G2D support only 2 plane YUV, so all YUV format should use YUV2P PPC
       table */
...
#endif // EXYNOS_RESOURCE_RESTRICTION_ZUMAPRO_H_
